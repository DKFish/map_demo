    ...
    function newContext(contextName) {
        ...
        function removeScript(name) {
            if (isBrowser) {
                each(scripts(), function (scriptNode) {
                    if (scriptNode.getAttribute("data-requiremodule") === name && scriptNode.getAttribute(
        ...
        function checkLoaded() {
            ...
            if ((!expired || usingPathFallback) && stillLoading) {
                ...
                if ((isBrowser || isWebWorker) && !checkLoadedTimeoutId) {
                    checkLoadedTimeoutId = _setTimeout(function () {
                ...
                if (!this.inited) {
                    ...
                    if (this.depCount < 1 && !this.defined) {
                        if (isFunction(factory)) {
                            ...
                            if (
                                (this.events.error && this.map.isDefine) || req.onError !== defaultOnError
                            ) {
                                try {
                ...
                on(pluginMap, "defined", bind(this, function (plugin) {
                    ...
                    load.error = bind(this, function (err) {
                        ...
                        eachProp(registry, function (mod) {
                            if (mod.map.id.indexOf(id + "_unnormalized") ===
                                0) {
                    ...
                    load.fromText = bind(this, function (text, textAlt) {
                        ...
                        try {
                            ...
                            return onError(makeError("fromtexteval",
                                "fromText eval for " + id + " failed: " + e, e,
                                [id]));
                        }
                        if (hasInteractive) {
                            useInteractive = true;
            ...
            enable: function () {
                ...
                each(this.depMaps, bind(this, function (depMap, i) {
                    ...
                    if (typeof depMap === "string") {
                        ...
                        depMap = makeModuleMap(depMap, this.map.isDefine ? this.map : this.map
                            .parentMap, false, !this.skipMap);
        ...
        function intakeDefines() {
            ...
            while (defQueue.length) {
                args = defQueue.shift();
                if (args[0] === null) {
                    return onError(makeError("mismatch", "Mismatched anonymous define() module: " + args[args
                        .length - 1]));
                } else {
        ...
        context = {
            ...
            configure: function (cfg) {
                ...
                if (cfg.packages) {
                    each(cfg.packages, function (pkgObj) {
                        ...
                        config.pkgs[name] = pkgObj.name + "/" + (pkgObj.main || "main").replace(
                            currDirRegExp, "").replace(jsSuffixRegExp, "");
                    });
                }
            ...
            makeRequire: function (relMap, options) {
                    ...
                    if (typeof deps === "string") {
                        ...
                        if (!hasProp(defined, id)) {
                            return onError(makeError("notloaded", 'Module name "' + id +
                                '" has not been loaded yet for context: ' + contextName + (relMap ?
                                    "" : ". Use require([])")));
                        }
                        return defined[id];
                    }
                ...
                mixin(localRequire, {
                    ...
                    toUrl: function (moduleNamePlusExt) {
                        ...
                        return context.nameToUrl(normalize(moduleNamePlusExt, relMap && relMap
                            .id, true), ext, true);
                    },
                    defined: function (id) {
            ...
            onScriptLoad: function (evt) {
                ...
                //all old browsers will be supported, but this one was easy enough
                //to support and still makes sense.
                if (evt.type === "load" || readyRegExp.test((evt.currentTarget || evt.srcElement)
                    .readyState)) {
    ...
    req.load = function (context, moduleName, url) {
        ...
        if (isBrowser) {
            ...
            try {
                ...
                context.onError(makeError("importscripts", "importScripts failed for " + moduleName + " at " +
                    url, e,
                    [moduleName]));
            }
        }
